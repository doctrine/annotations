   ...
   /**
    ...
    public function testAnnotationWithAttributesError($attribute,$type,$value,$given) : void
    {
        ...
        try {
            ...
            self::assertStringContainsString("[Type Error] Attribute \"$attribute\" of @Doctrine\Tests\Annotations\Fixtures\AnnotationWithAttributes declared on property SomeClassName::invalidProperty. expects a(n) $type, but got $given.", $exc->getMessage());
        }
    }
   ...
   /**
    ...
    public function testAnnotationWithAttributesWithVarTypeArrayError($attribute,$type,$value,$given) : void
    {
        ...
        try {
            ...
            self::assertStringContainsString("[Type Error] Attribute \"$attribute\" of @Doctrine\Tests\Annotations\Fixtures\AnnotationWithAttributes declared on property SomeClassName::invalidProperty. expects either a(n) $type, or an array of {$type}s, but got $given.", $exc->getMessage());
        }
    }
    ...
    public function testAnnotationWithRequiredAttributes() : void
    {
        ...
        try {
            ...
            self::assertStringContainsString('Attribute "annot" of @Doctrine\Tests\Annotations\Fixtures\AnnotationWithRequiredAttributes declared on property SomeClassName::invalidProperty. expects a(n) Doctrine\Tests\Annotations\Fixtures\AnnotationTargetAnnotation. This value should not be null.', $exc->getMessage());
        }
        ...
        try {
            ...
            self::assertStringContainsString('Attribute "value" of @Doctrine\Tests\Annotations\Fixtures\AnnotationWithRequiredAttributes declared on property SomeClassName::invalidProperty. expects a(n) string. This value should not be null.', $exc->getMessage());
        }
    ...
    public function testAnnotationWithRequiredAttributesWithoutConstructor() : void
    {
        ...
        try {
            ...
            self::assertStringContainsString('Attribute "annot" of @Doctrine\Tests\Annotations\Fixtures\AnnotationWithRequiredAttributesWithoutConstructor declared on property SomeClassName::invalidProperty. expects a(n) \Doctrine\Tests\Annotations\Fixtures\AnnotationTargetAnnotation. This value should not be null.', $exc->getMessage());
        }
        ...
        try {
            ...
            self::assertStringContainsString('Attribute "value" of @Doctrine\Tests\Annotations\Fixtures\AnnotationWithRequiredAttributesWithoutConstructor declared on property SomeClassName::invalidProperty. expects a(n) string. This value should not be null.', $exc->getMessage());
        }
    ...
    public function testAnnotationEnumeratorException() : void
    {
        ...
        $this->expectExceptionMessage(
            sprintf(
                'Attribute "value" of @%s declared on property SomeClassName::invalidProperty. accept only "ONE"|"TWO"|"THREE", but got FOUR.',
                Fixtures\AnnotationEnum::class
            )
        );
    ...
    public function testAnnotationEnumeratorLiteralException() : void
    {
        ...
        $this->expectExceptionMessage(
            sprintf(
                'Attribute "value" of @%s declared on property SomeClassName::invalidProperty. accept only 1|2|3, but got 4.',
                Fixtures\AnnotationEnumLiteral::class
            )
        );
...
DOCBLOCK;
    ...
    public function testSyntaxErrorWithContextDescription() : void
    {
        ...
        $this->expectExceptionMessage(
            sprintf(
                "Expected PlainValue, got ''' at position 10 in class \\%s",
                Name::class
            )
        );
...
DOCBLOCK;
    ...
    public function testInvalidIdentifierInAnnotation() : void
    {
        ...
        $this->expectExceptionMessage(
            sprintf(
                '[Syntax Error] Expected %1$s::T_IDENTIFIER or %1$s::T_TRUE or %1$s::T_FALSE or %1$s::T_NULL, got \'3.42\' at position 5.',
                DocLexer::class
            )
        );
