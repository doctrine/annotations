 ...
 * @Attributes({
      ...
      @Attribute("annotation",           type = "Doctrine\Tests\Annotations\Fixtures\AnnotationTargetAll"),
      @Attribute("arrayOfAnnotations",   type = "array<Doctrine\Tests\Annotations\Fixtures\AnnotationTargetAll>"),
  })
 */
final class AnnotationWithAttributes
{
    ...
    /**
     * @return \Doctrine\Tests\Annotations\Fixtures\AnnotationTargetAll
     */
    ...
    /**
     * @return array<Doctrine\Tests\Annotations\Fixtures\AnnotationTargetAll>
     */
